...
export interface SeleRepositoryDTO {
  ...
  findTimeLine: (storeId: number, sellerId: number, from: string, to: string) => Promise<ISale[]>;
  ...
  findByStorePerPeriod: (storeId: number, from?: string, to?: string) => Promise<ISale[]>;
